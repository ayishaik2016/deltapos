"use strict";
    ...
    $("#itemDispatchForm").on("submit", function(e) {
        e.preventDefault();
        const form = $(this);
        const formArray = {
            formId: form.attr("id"),
    ...
    function pageRedirect(formObject){
        ...
        if(formObject.response.id !== undefined){
            redirectTo = '/item-dispatch/details/'+formObject.response.id;
        }else{
            redirectTo = '/item-dispatch/list';
        }
        setTimeout(function() {
